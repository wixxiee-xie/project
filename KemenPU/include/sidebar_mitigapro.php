<div class="sidebar" id="sidebar">
  ...
  <div>
    ...
    <ul>
      <li>
        <a href="belanja_modal.php?menu=dashboard" 
      ...
      <li>
        <a href="belanja_modal.php?menu=belanja_modal" 
      ...
      <li>
        <a href="belanja_modal.php?menu=bmn" 
      ...
      <li>
        <a href="belanja_modal.php?menu=pelatihan" 
      ...
      <li>
        <a href="belanja_modal.php?menu=skp" 
      ...
      <li>
        <a href="belanja_modal.php?menu=tukin" 
